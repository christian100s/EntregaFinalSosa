...
const comienzo = DateTime.now();
console.log(comienzo.toString())
...
//Funcion con boton de compra de articulos
...
botonVacio.style.padding ="1% 0% 1% 2%"
botonVacio.innerHTML += '<button type="button" class="btn btn-danger">Vaciar</button>';
...
ordenPrecio.onclick =()=>{
    ...
    ocultos(ocultoAlfabeto);
    ordenPrecio.className="btn btn-outline-primary disabled"
};
...
ordenAlfabeto.addEventListener("click", ()=>{
    ...
    ocultos(ocultoPrecio);
    ordenAlfabeto.className="btn btn-outline-primary disabled"
});
